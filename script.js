...
<head>
  ...
  <title>Landen419 Edpuzzle For: ${media.title}</title>
</head>
<body>
  <div class="container">
    <header>
    ...
    <footer>
      <p>Made by: <a href="https://landen419.com" target="_blank">Landen419</a> | Website: <a href="https://landen419.com" target="_blank">landen419.com</a></p>
    </footer>
  </div>
</body>
</html>`;
